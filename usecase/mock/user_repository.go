...
type UserRepositoryMock struct {
	...
	funcAdd          func(name string) (err error)
	inspectFuncAdd   func(name string)
...
func (mmAdd *mUserRepositoryMockAdd) Expect(name string) *mUserRepositoryMockAdd {
	...
	mmAdd.defaultExpectation.params = &UserRepositoryMockAddParams{name}
...
func (mmAdd *mUserRepositoryMockAdd) Inspect(f func(name string)) *mUserRepositoryMockAdd {
...
func (mmAdd *mUserRepositoryMockAdd) Set(f func(name string) (err error)) *UserRepositoryMock {
	if mmAdd.defaultExpectation != nil {
...
// Then helper
func (mmAdd *mUserRepositoryMockAdd) When(name string) *UserRepositoryMockAddExpectation {
	if mmAdd.mock.funcAdd != nil {
		mmAdd.mock.t.Fatalf("UserRepositoryMock.Add mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockAddExpectation{
		mock:   mmAdd.mock,
		params: &UserRepositoryMockAddParams{name},
	}
...
func (mmAdd *UserRepositoryMock) Add(name string) (err error) {
	mm_atomic.AddUint64(&mmAdd.beforeAddCounter, 1)
	defer mm_atomic.AddUint64(&mmAdd.afterAddCounter, 1)

	if mmAdd.inspectFuncAdd != nil {
		mmAdd.inspectFuncAdd(name)
	}

	mm_params := &UserRepositoryMockAddParams{name}
	...
	if mmAdd.AddMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockAddParams{name}
	...
	if mmAdd.funcAdd != nil {
		return mmAdd.funcAdd(name)
	}
	mmAdd.t.Fatalf("Unexpected call to UserRepositoryMock.Add. %v", name)
	return
}
...
func (mmDelete *mUserRepositoryMockDelete) Expect(userID int) *mUserRepositoryMockDelete {
	...
	mmDelete.defaultExpectation.params = &UserRepositoryMockDeleteParams{userID}
...
func (mmDelete *mUserRepositoryMockDelete) When(userID int) *UserRepositoryMockDeleteExpectation {
	...
	expectation := &UserRepositoryMockDeleteExpectation{
		mock:   mmDelete.mock,
		params: &UserRepositoryMockDeleteParams{userID},
	}
...
func (mmDelete *UserRepositoryMock) Delete(userID int) (err error) {
	...
	if mmDelete.inspectFuncDelete != nil {
		mmDelete.inspectFuncDelete(userID)
	}

	mm_params := &UserRepositoryMockDeleteParams{userID}
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockDeleteParams{userID}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmDelete.funcDelete != nil {
		return mmDelete.funcDelete(userID)
	}
	mmDelete.t.Fatalf("Unexpected call to UserRepositoryMock.Delete. %v", userID)
	return
}
...
func (mmGet *mUserRepositoryMockGet) Expect(userID int) *mUserRepositoryMockGet {
	...
	mmGet.defaultExpectation.params = &UserRepositoryMockGetParams{userID}
...
func (mmGet *mUserRepositoryMockGet) When(userID int) *UserRepositoryMockGetExpectation {
	...
	expectation := &UserRepositoryMockGetExpectation{
		mock:   mmGet.mock,
		params: &UserRepositoryMockGetParams{userID},
	}
...
func (mmGet *UserRepositoryMock) Get(userID int) (up1 *entity.User, err error) {
	...
	mm_params := &UserRepositoryMockGetParams{userID}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockGetParams{userID}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmGet.t.Fatalf("Unexpected call to UserRepositoryMock.Get. %v", userID)
	return
}
...
func (mmUpdateCaption *mUserRepositoryMockUpdateCaption) Expect(userID int, caption string) *mUserRepositoryMockUpdateCaption {
	...
	mmUpdateCaption.defaultExpectation.params = &UserRepositoryMockUpdateCaptionParams{userID, caption}
...
func (mmUpdateCaption *mUserRepositoryMockUpdateCaption) When(userID int, caption string) *UserRepositoryMockUpdateCaptionExpectation {
	...
	expectation := &UserRepositoryMockUpdateCaptionExpectation{
		...
		params: &UserRepositoryMockUpdateCaptionParams{userID, caption},
	}
...
func (mmUpdateCaption *UserRepositoryMock) UpdateCaption(userID int, caption string) (err error) {
	...
	if mmUpdateCaption.inspectFuncUpdateCaption != nil {
		mmUpdateCaption.inspectFuncUpdateCaption(userID, caption)
	}

	mm_params := &UserRepositoryMockUpdateCaptionParams{userID, caption}
	...
	if mmUpdateCaption.UpdateCaptionMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateCaptionParams{userID, caption}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmUpdateCaption.funcUpdateCaption != nil {
		return mmUpdateCaption.funcUpdateCaption(userID, caption)
	}
	mmUpdateCaption.t.Fatalf("Unexpected call to UserRepositoryMock.UpdateCaption. %v %v", userID, caption)
	return
}
