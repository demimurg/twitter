...
type RegistratorMock struct {
	...
	funcDeactivateUser          func(ctx context.Context, userID int) (err error)
	inspectFuncDeactivateUser   func(ctx context.Context, userID int)
	afterDeactivateUserCounter  uint64
	beforeDeactivateUserCounter uint64
	DeactivateUserMock          mRegistratorMockDeactivateUser

	funcRegisterUser          func(ctx context.Context, name string, email string, birthDate *time.Time) (up1 *entity.User, err error)
	inspectFuncRegisterUser   func(ctx context.Context, name string, email string, birthDate *time.Time)
...
func (mmDeactivateUser *mRegistratorMockDeactivateUser) Expect(ctx context.Context, userID int) *mRegistratorMockDeactivateUser {
	...
	mmDeactivateUser.defaultExpectation.params = &RegistratorMockDeactivateUserParams{ctx, userID}
...
func (mmDeactivateUser *mRegistratorMockDeactivateUser) Inspect(f func(ctx context.Context, userID int)) *mRegistratorMockDeactivateUser {
...
// Then helper
func (mmDeactivateUser *mRegistratorMockDeactivateUser) When(ctx context.Context, userID int) *RegistratorMockDeactivateUserExpectation {
	if mmDeactivateUser.mock.funcDeactivateUser != nil {
		mmDeactivateUser.mock.t.Fatalf("RegistratorMock.DeactivateUser mock is already set by Set")
	}
	...
	expectation := &RegistratorMockDeactivateUserExpectation{
		...
		params: &RegistratorMockDeactivateUserParams{ctx, userID},
	}
...
func (mmDeactivateUser *RegistratorMock) DeactivateUser(ctx context.Context, userID int) (err error) {
	...
	if mmDeactivateUser.inspectFuncDeactivateUser != nil {
		mmDeactivateUser.inspectFuncDeactivateUser(ctx, userID)
	}

	mm_params := &RegistratorMockDeactivateUserParams{ctx, userID}
	...
	if mmDeactivateUser.DeactivateUserMock.defaultExpectation != nil {
		...
		mm_got := RegistratorMockDeactivateUserParams{ctx, userID}
	...
	if mmDeactivateUser.funcDeactivateUser != nil {
		return mmDeactivateUser.funcDeactivateUser(ctx, userID)
	}
	mmDeactivateUser.t.Fatalf("Unexpected call to RegistratorMock.DeactivateUser. %v %v", ctx, userID)
	return
}
...
func (mmRegisterUser *mRegistratorMockRegisterUser) Expect(ctx context.Context, name string, email string, birthDate *time.Time) *mRegistratorMockRegisterUser {
	...
	mmRegisterUser.defaultExpectation.params = &RegistratorMockRegisterUserParams{ctx, name, email, birthDate}
...
func (mmRegisterUser *mRegistratorMockRegisterUser) Inspect(f func(ctx context.Context, name string, email string, birthDate *time.Time)) *mRegistratorMockRegisterUser {
...
// Then helper
func (mmRegisterUser *mRegistratorMockRegisterUser) When(ctx context.Context, name string, email string, birthDate *time.Time) *RegistratorMockRegisterUserExpectation {
	if mmRegisterUser.mock.funcRegisterUser != nil {
		mmRegisterUser.mock.t.Fatalf("RegistratorMock.RegisterUser mock is already set by Set")
	}
	...
	expectation := &RegistratorMockRegisterUserExpectation{
		...
		params: &RegistratorMockRegisterUserParams{ctx, name, email, birthDate},
	}
...
func (mmRegisterUser *RegistratorMock) RegisterUser(ctx context.Context, name string, email string, birthDate *time.Time) (up1 *entity.User, err error) {
	...
	if mmRegisterUser.inspectFuncRegisterUser != nil {
		mmRegisterUser.inspectFuncRegisterUser(ctx, name, email, birthDate)
	}

	mm_params := &RegistratorMockRegisterUserParams{ctx, name, email, birthDate}
	...
	if mmRegisterUser.RegisterUserMock.defaultExpectation != nil {
		...
		mm_got := RegistratorMockRegisterUserParams{ctx, name, email, birthDate}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmRegisterUser.funcRegisterUser != nil {
		return mmRegisterUser.funcRegisterUser(ctx, name, email, birthDate)
	}
	mmRegisterUser.t.Fatalf("Unexpected call to RegistratorMock.RegisterUser. %v %v %v %v", ctx, name, email, birthDate)
	return
}
