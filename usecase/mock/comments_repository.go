...
type CommentsRepositoryMock struct {
	...
	funcAdd          func(userID int, tweetID string, text string) (err error)
	inspectFuncAdd   func(userID int, tweetID string, text string)
	afterAddCounter  uint64
	beforeAddCounter uint64
	AddMock          mCommentsRepositoryMockAdd

	funcUpdateText          func(commentID int, newText string) (err error)
	inspectFuncUpdateText   func(commentID int, newText string)
...
func (mmAdd *mCommentsRepositoryMockAdd) Expect(userID int, tweetID string, text string) *mCommentsRepositoryMockAdd {
	...
	mmAdd.defaultExpectation.params = &CommentsRepositoryMockAddParams{userID, tweetID, text}
...
func (mmAdd *mCommentsRepositoryMockAdd) Inspect(f func(userID int, tweetID string, text string)) *mCommentsRepositoryMockAdd {
...
func (mmAdd *mCommentsRepositoryMockAdd) Set(f func(userID int, tweetID string, text string) (err error)) *CommentsRepositoryMock {
	if mmAdd.defaultExpectation != nil {
...
// Then helper
func (mmAdd *mCommentsRepositoryMockAdd) When(userID int, tweetID string, text string) *CommentsRepositoryMockAddExpectation {
	if mmAdd.mock.funcAdd != nil {
		mmAdd.mock.t.Fatalf("CommentsRepositoryMock.Add mock is already set by Set")
	}
	...
	expectation := &CommentsRepositoryMockAddExpectation{
		mock:   mmAdd.mock,
		params: &CommentsRepositoryMockAddParams{userID, tweetID, text},
	}
...
func (mmAdd *CommentsRepositoryMock) Add(userID int, tweetID string, text string) (err error) {
	mm_atomic.AddUint64(&mmAdd.beforeAddCounter, 1)
	defer mm_atomic.AddUint64(&mmAdd.afterAddCounter, 1)

	if mmAdd.inspectFuncAdd != nil {
		mmAdd.inspectFuncAdd(userID, tweetID, text)
	}

	mm_params := &CommentsRepositoryMockAddParams{userID, tweetID, text}
	...
	if mmAdd.AddMock.defaultExpectation != nil {
		...
		mm_got := CommentsRepositoryMockAddParams{userID, tweetID, text}
	...
	if mmAdd.funcAdd != nil {
		return mmAdd.funcAdd(userID, tweetID, text)
	}
	mmAdd.t.Fatalf("Unexpected call to CommentsRepositoryMock.Add. %v %v %v", userID, tweetID, text)
	return
}
...
func (mmUpdateText *mCommentsRepositoryMockUpdateText) Expect(commentID int, newText string) *mCommentsRepositoryMockUpdateText {
	...
	mmUpdateText.defaultExpectation.params = &CommentsRepositoryMockUpdateTextParams{commentID, newText}
...
func (mmUpdateText *mCommentsRepositoryMockUpdateText) Inspect(f func(commentID int, newText string)) *mCommentsRepositoryMockUpdateText {
...
func (mmUpdateText *mCommentsRepositoryMockUpdateText) Set(f func(commentID int, newText string) (err error)) *CommentsRepositoryMock {
	if mmUpdateText.defaultExpectation != nil {
...
// Then helper
func (mmUpdateText *mCommentsRepositoryMockUpdateText) When(commentID int, newText string) *CommentsRepositoryMockUpdateTextExpectation {
	if mmUpdateText.mock.funcUpdateText != nil {
		mmUpdateText.mock.t.Fatalf("CommentsRepositoryMock.UpdateText mock is already set by Set")
	}
	...
	expectation := &CommentsRepositoryMockUpdateTextExpectation{
		...
		params: &CommentsRepositoryMockUpdateTextParams{commentID, newText},
	}
...
func (mmUpdateText *CommentsRepositoryMock) UpdateText(commentID int, newText string) (err error) {
	...
	if mmUpdateText.inspectFuncUpdateText != nil {
		mmUpdateText.inspectFuncUpdateText(commentID, newText)
	}

	mm_params := &CommentsRepositoryMockUpdateTextParams{commentID, newText}
	...
	if mmUpdateText.UpdateTextMock.defaultExpectation != nil {
		...
		mm_got := CommentsRepositoryMockUpdateTextParams{commentID, newText}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmUpdateText.funcUpdateText != nil {
		return mmUpdateText.funcUpdateText(commentID, newText)
	}
	mmUpdateText.t.Fatalf("Unexpected call to CommentsRepositoryMock.UpdateText. %v %v", commentID, newText)
	return
}
