...
type FollowerRepositoryMock struct {
	...
	funcAdd          func(followerID int, toUserID int) (err error)
	inspectFuncAdd   func(followerID int, toUserID int)
	afterAddCounter  uint64
	beforeAddCounter uint64
	AddMock          mFollowerRepositoryMockAdd

	funcGetFollowers          func(userID int, topN int) (ia1 []int, err error)
	inspectFuncGetFollowers   func(userID int, topN int)
	afterGetFollowersCounter  uint64
	beforeGetFollowersCounter uint64
	GetFollowersMock          mFollowerRepositoryMockGetFollowers

	funcGetFollowing          func(userID int, topN int) (ia1 []int, err error)
	inspectFuncGetFollowing   func(userID int, topN int)
	afterGetFollowingCounter  uint64
	beforeGetFollowingCounter uint64
	GetFollowingMock          mFollowerRepositoryMockGetFollowing

	funcRemove          func(followerID int, fromUserID int) (err error)
	inspectFuncRemove   func(followerID int, fromUserID int)
...
func (mmAdd *mFollowerRepositoryMockAdd) Expect(followerID int, toUserID int) *mFollowerRepositoryMockAdd {
	...
	mmAdd.defaultExpectation.params = &FollowerRepositoryMockAddParams{followerID, toUserID}
...
func (mmAdd *mFollowerRepositoryMockAdd) Inspect(f func(followerID int, toUserID int)) *mFollowerRepositoryMockAdd {
...
func (mmAdd *mFollowerRepositoryMockAdd) Set(f func(followerID int, toUserID int) (err error)) *FollowerRepositoryMock {
	if mmAdd.defaultExpectation != nil {
...
// Then helper
func (mmAdd *mFollowerRepositoryMockAdd) When(followerID int, toUserID int) *FollowerRepositoryMockAddExpectation {
	if mmAdd.mock.funcAdd != nil {
		mmAdd.mock.t.Fatalf("FollowerRepositoryMock.Add mock is already set by Set")
	}
	...
	expectation := &FollowerRepositoryMockAddExpectation{
		mock:   mmAdd.mock,
		params: &FollowerRepositoryMockAddParams{followerID, toUserID},
	}
...
func (mmAdd *FollowerRepositoryMock) Add(followerID int, toUserID int) (err error) {
	mm_atomic.AddUint64(&mmAdd.beforeAddCounter, 1)
	defer mm_atomic.AddUint64(&mmAdd.afterAddCounter, 1)

	if mmAdd.inspectFuncAdd != nil {
		mmAdd.inspectFuncAdd(followerID, toUserID)
	}

	mm_params := &FollowerRepositoryMockAddParams{followerID, toUserID}
	...
	if mmAdd.AddMock.defaultExpectation != nil {
		...
		mm_got := FollowerRepositoryMockAddParams{followerID, toUserID}
	...
	if mmAdd.funcAdd != nil {
		return mmAdd.funcAdd(followerID, toUserID)
	}
	mmAdd.t.Fatalf("Unexpected call to FollowerRepositoryMock.Add. %v %v", followerID, toUserID)
	return
}
...
func (mmGetFollowers *mFollowerRepositoryMockGetFollowers) Expect(userID int, topN int) *mFollowerRepositoryMockGetFollowers {
	...
	mmGetFollowers.defaultExpectation.params = &FollowerRepositoryMockGetFollowersParams{userID, topN}
...
func (mmGetFollowers *mFollowerRepositoryMockGetFollowers) Inspect(f func(userID int, topN int)) *mFollowerRepositoryMockGetFollowers {
...
func (mmGetFollowers *mFollowerRepositoryMockGetFollowers) Set(f func(userID int, topN int) (ia1 []int, err error)) *FollowerRepositoryMock {
	if mmGetFollowers.defaultExpectation != nil {
...
// Then helper
func (mmGetFollowers *mFollowerRepositoryMockGetFollowers) When(userID int, topN int) *FollowerRepositoryMockGetFollowersExpectation {
	if mmGetFollowers.mock.funcGetFollowers != nil {
		mmGetFollowers.mock.t.Fatalf("FollowerRepositoryMock.GetFollowers mock is already set by Set")
	}
	...
	expectation := &FollowerRepositoryMockGetFollowersExpectation{
		...
		params: &FollowerRepositoryMockGetFollowersParams{userID, topN},
	}
...
func (mmGetFollowers *FollowerRepositoryMock) GetFollowers(userID int, topN int) (ia1 []int, err error) {
	...
	if mmGetFollowers.inspectFuncGetFollowers != nil {
		mmGetFollowers.inspectFuncGetFollowers(userID, topN)
	}

	mm_params := &FollowerRepositoryMockGetFollowersParams{userID, topN}
	...
	if mmGetFollowers.GetFollowersMock.defaultExpectation != nil {
		...
		mm_got := FollowerRepositoryMockGetFollowersParams{userID, topN}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetFollowers.funcGetFollowers != nil {
		return mmGetFollowers.funcGetFollowers(userID, topN)
	}
	mmGetFollowers.t.Fatalf("Unexpected call to FollowerRepositoryMock.GetFollowers. %v %v", userID, topN)
	return
}
...
func (mmGetFollowing *mFollowerRepositoryMockGetFollowing) Expect(userID int, topN int) *mFollowerRepositoryMockGetFollowing {
	...
	mmGetFollowing.defaultExpectation.params = &FollowerRepositoryMockGetFollowingParams{userID, topN}
...
func (mmGetFollowing *mFollowerRepositoryMockGetFollowing) Inspect(f func(userID int, topN int)) *mFollowerRepositoryMockGetFollowing {
...
func (mmGetFollowing *mFollowerRepositoryMockGetFollowing) Set(f func(userID int, topN int) (ia1 []int, err error)) *FollowerRepositoryMock {
	if mmGetFollowing.defaultExpectation != nil {
...
// Then helper
func (mmGetFollowing *mFollowerRepositoryMockGetFollowing) When(userID int, topN int) *FollowerRepositoryMockGetFollowingExpectation {
	if mmGetFollowing.mock.funcGetFollowing != nil {
		mmGetFollowing.mock.t.Fatalf("FollowerRepositoryMock.GetFollowing mock is already set by Set")
	}
	...
	expectation := &FollowerRepositoryMockGetFollowingExpectation{
		...
		params: &FollowerRepositoryMockGetFollowingParams{userID, topN},
	}
...
func (mmGetFollowing *FollowerRepositoryMock) GetFollowing(userID int, topN int) (ia1 []int, err error) {
	...
	if mmGetFollowing.inspectFuncGetFollowing != nil {
		mmGetFollowing.inspectFuncGetFollowing(userID, topN)
	}

	mm_params := &FollowerRepositoryMockGetFollowingParams{userID, topN}
	...
	if mmGetFollowing.GetFollowingMock.defaultExpectation != nil {
		...
		mm_got := FollowerRepositoryMockGetFollowingParams{userID, topN}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmGetFollowing.funcGetFollowing != nil {
		return mmGetFollowing.funcGetFollowing(userID, topN)
	}
	mmGetFollowing.t.Fatalf("Unexpected call to FollowerRepositoryMock.GetFollowing. %v %v", userID, topN)
	return
}
...
func (mmRemove *mFollowerRepositoryMockRemove) Expect(followerID int, fromUserID int) *mFollowerRepositoryMockRemove {
	...
	mmRemove.defaultExpectation.params = &FollowerRepositoryMockRemoveParams{followerID, fromUserID}
...
func (mmRemove *mFollowerRepositoryMockRemove) Inspect(f func(followerID int, fromUserID int)) *mFollowerRepositoryMockRemove {
...
func (mmRemove *mFollowerRepositoryMockRemove) Set(f func(followerID int, fromUserID int) (err error)) *FollowerRepositoryMock {
	if mmRemove.defaultExpectation != nil {
...
// Then helper
func (mmRemove *mFollowerRepositoryMockRemove) When(followerID int, fromUserID int) *FollowerRepositoryMockRemoveExpectation {
	if mmRemove.mock.funcRemove != nil {
		mmRemove.mock.t.Fatalf("FollowerRepositoryMock.Remove mock is already set by Set")
	}
	...
	expectation := &FollowerRepositoryMockRemoveExpectation{
		mock:   mmRemove.mock,
		params: &FollowerRepositoryMockRemoveParams{followerID, fromUserID},
	}
...
func (mmRemove *FollowerRepositoryMock) Remove(followerID int, fromUserID int) (err error) {
	...
	if mmRemove.inspectFuncRemove != nil {
		mmRemove.inspectFuncRemove(followerID, fromUserID)
	}

	mm_params := &FollowerRepositoryMockRemoveParams{followerID, fromUserID}
	...
	if mmRemove.RemoveMock.defaultExpectation != nil {
		...
		mm_got := FollowerRepositoryMockRemoveParams{followerID, fromUserID}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmRemove.funcRemove != nil {
		return mmRemove.funcRemove(followerID, fromUserID)
	}
	mmRemove.t.Fatalf("Unexpected call to FollowerRepositoryMock.Remove. %v %v", followerID, fromUserID)
	return
}
