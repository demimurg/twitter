...
//go:generate minimock -i github.com/demimurg/twitter/internal/usecase.ScamDetectorClient -o ./internal/usecase/mock/scam_detector_client.go -n ScamDetectorClientMock
...
type ScamDetectorClientMock struct {
	...
	funcCheckEmail          func(ctx context.Context, email string) (err error)
	inspectFuncCheckEmail   func(ctx context.Context, email string)
...
func (mmCheckEmail *mScamDetectorClientMockCheckEmail) Expect(ctx context.Context, email string) *mScamDetectorClientMockCheckEmail {
	...
	mmCheckEmail.defaultExpectation.params = &ScamDetectorClientMockCheckEmailParams{ctx, email}
...
func (mmCheckEmail *mScamDetectorClientMockCheckEmail) Inspect(f func(ctx context.Context, email string)) *mScamDetectorClientMockCheckEmail {
...
// Then helper
func (mmCheckEmail *mScamDetectorClientMockCheckEmail) When(ctx context.Context, email string) *ScamDetectorClientMockCheckEmailExpectation {
	if mmCheckEmail.mock.funcCheckEmail != nil {
		mmCheckEmail.mock.t.Fatalf("ScamDetectorClientMock.CheckEmail mock is already set by Set")
	}
	...
	expectation := &ScamDetectorClientMockCheckEmailExpectation{
		...
		params: &ScamDetectorClientMockCheckEmailParams{ctx, email},
	}
...
func (mmCheckEmail *ScamDetectorClientMock) CheckEmail(ctx context.Context, email string) (err error) {
	...
	if mmCheckEmail.inspectFuncCheckEmail != nil {
		mmCheckEmail.inspectFuncCheckEmail(ctx, email)
	}

	mm_params := &ScamDetectorClientMockCheckEmailParams{ctx, email}
	...
	if mmCheckEmail.CheckEmailMock.defaultExpectation != nil {
		...
		mm_got := ScamDetectorClientMockCheckEmailParams{ctx, email}
	...
	if mmCheckEmail.funcCheckEmail != nil {
		return mmCheckEmail.funcCheckEmail(ctx, email)
	}
	mmCheckEmail.t.Fatalf("Unexpected call to ScamDetectorClientMock.CheckEmail. %v %v", ctx, email)
	return
}
